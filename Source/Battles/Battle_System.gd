...
var base_model = preload("res://Monsters/M1 normal.png")
var DMG_model= preload("res://Monsters/M1 damage.png")
...
func _process(delta):
	...
	if Enemy_health.value <= 0:
		MusicControl.play_basic_music()
		get_tree().change_scene("res://Map/4/Room6/Room6.tscn")
